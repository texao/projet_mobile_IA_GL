...
// Ajouter une configuration pour testLogging
tasks.withType<Test> {
    testLogging {
        events("passed", "failed", "skipped")
        exceptionFormat =
            TestExceptionFormat.FULL  // Remplacez "full" par TestExceptionFormat.FULL    }
    }
}
...
sonar {
        properties {
            ...
            property("sonar.organization", "texao")  // SonarCloud
            ...
            property("sonar.java.coveragePlugin", "jacoco")  // JaCoCo pour générer des rapports de couverture
            property("sonar.junit.reportsPath", "$buildDir/test-logs") // Spécifie le chemin des rapports de tests JUnit
            property("sonar.jacoco.reportPaths", "$buildDir/jacoco/testDebugUnitTest.exec") // Spécifie le chemin du rapport de couverture généré
        }
    }
